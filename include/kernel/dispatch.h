...
void sys_send (int dest_pid, void *buffer, int length);
void sys_recv (int src_pid, void *buffer, int length);
void sys_send0 (int dest_pid, void *obuf, int olen, void *ibuf, int ilen);
void sys_recv0 (int src_pid, void *buffer, int length);
